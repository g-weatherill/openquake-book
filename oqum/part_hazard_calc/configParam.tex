...
\begin{center}
\subfigure[]{
\includegraphics[width=6cm]{./oqum/figures/areaSrcGrid01.eps}}
\subfigure[]{
\includegraphics[width=6cm]{./oqum/figures/areaSrcGrid005.eps}}\\
...
\begin{center}
\subfigure[]{
\includegraphics[width=12cm]{./oqum/figures/areaSrcPointRupture.eps}}
\subfigure[]{
\includegraphics[width=12cm]{./oqum/figures/areaSrcFiniteRuptureGivenStrike.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=8cm]{./oqum/figures/areaSrcFiniteRuptureGivenStrike2.eps}}
\subfigure[]{
\includegraphics[width=8cm]{./oqum/figures/areaSrcFiniteRuptureRandom.eps}}
\subfigure[]{
\includegraphics[width=8cm]{./oqum/figures/areaSrcFiniteRuptureCross.eps}}
\subfigure[]{
\includegraphics[width=8cm]{./oqum/figures/areaSrcFiniteRuptureSpoked.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMesh.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag5.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6.eps}}
...
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6AR2.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6AR4.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6MagLengthRel.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6AR2MagLengthRel.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/simpleFaultMag6AR4MagLengthRel.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_1.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_2.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_3.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_4.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_5.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_6.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_7.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_8.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_9.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_10.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_11.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_12.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_13.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_14.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_15.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_16.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_17.eps}}
\subfigure[]{
\includegraphics[width=4cm]{./oqum/figures/mag6_18.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingMag5OffSet10km.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingMag5OffSet5km.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingMag5OffSet1km.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingCentered.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingFullDDW.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/ruptFloatingMag5OffSet1km.eps}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/complexFaultMesh.eps}}
\subfigure[]{
\includegraphics[width=5cm]{./oqum/figures/complexFaultRupMag6.eps}}
...
\item \Verb+MAXIMUM_DISTANCE+: maximum distance (in km) of sources to be considered in the calculation. Sources more than this distance away are ignored.
\item \Verb+WIDTH_OF_MFD_BIN+: discretization interval for  magnitude-frequency distribution.
\item \Verb+INTENSITY_MEASURE_LEVELS+: comma separated list of intensity measure levels for which to compute probability of exceedance. In the same units of the chosen intensity measure type.
\item \Verb+COMPUTE_MEAN_HAZARD_CURVE+: if true, mean hazard curves are calculated and saved to file.
\item \Verb+QUANTILE_LEVELS+: one or more quantile levels for computing quantile hazard curves. It can be left empty if no quantile curves are requested.
\item \Verb+POES+: on or more probability values for computing hazard maps (from mean and quantile hazard curves).
\end{itemize}
...
\item \Verb+DISTANCE_BIN_LIMITS+: comma separated list of distance values (in km), defining distance bin edges.
